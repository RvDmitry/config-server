package my.home.dmitry.cloud.station.weather.third.service;
...
public class SendMessageTask {
    ...
    private static final String CITY = "Омск";
    ...
    public void send() throws ExecutionException, InterruptedException {
        var message = String.format(CITY + " T° %d", getTemperature(-30, 30));
